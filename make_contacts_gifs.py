...
def make_contact_frames(folder, edges_files, output_folder):
    v_min = np.inf
    v_max = -np.inf
    ...
    for file_path in edges_files:
        ...
        plot_contact_map(rin, 'HBOND', output, v_min, v_max, min_id, max_id)
...
if __name__ == "__main__":
    ...
    for dataset in datasets:
        ...
        make_contact_frames(dataset, edges_files, output_folder)
